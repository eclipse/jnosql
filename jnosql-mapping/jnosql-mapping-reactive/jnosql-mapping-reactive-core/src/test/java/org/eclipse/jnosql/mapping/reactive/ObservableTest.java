...
class ObservableTest {
    ...
    public void shouldReturnFirst() {
        ...
        assertEquals(new Animal("Lion"), reference.get());
    }
    ...
    public void shouldReturnCollect() {
        ...
        result.thenAccept(reference::set);
        assertThat(reference.get(), Matchers.containsInAnyOrder(new Animal("Lion"),
                new Animal("Tiger")));
    }
    ...
    public void shouldBlockFirst() {
        ...
        assertEquals(new Animal("Lion"), singleResult.get());
    }
    ...
    public void shouldBlockCollect() {
        ...
        assertThat(result, Matchers.containsInAnyOrder(new Animal("Lion"),
                new Animal("Tiger")));
    }

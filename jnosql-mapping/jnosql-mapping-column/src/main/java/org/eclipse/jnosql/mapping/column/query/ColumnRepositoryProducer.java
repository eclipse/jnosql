...
public class ColumnRepositoryProducer {
     ...
     */
    public <T, K, R extends NoSQLRepository<T, K>> R get(Class<R> repositoryClass, ColumnManager manager) {
     ...
     * @throws NullPointerException when there is null parameter
     */
    public <T, K, R extends NoSQLRepository<T, K>> R get(Class<R> repositoryClass, JNoSQLColumnTemplate template) {
        Objects.requireNonNull(repositoryClass, "repository class is required");

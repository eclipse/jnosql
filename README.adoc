...
image::https://sonarcloud.io/api/project_badges/quality_gate?project=org.eclipse.jnosql%3Ajakarta-nosql-parent[window=_blank, link=https://sonarcloud.io/summary/new_code?id=org.eclipse.jnosql%3Ajakarta-nosql-parent]

[%autowidth,cols="a,a,a", frame=none, grid=none, role=center, align=center]
|===
| image::https://sonarcloud.io/api/project_badges/measure?project=org.eclipse.jnosql%3Ajakarta-nosql-parent&metric=sqale_rating[ link=https://sonarcloud.io/summary/new_code?id=org.eclipse.jnosql%3Ajakarta-nosql-parent,window=_blank]

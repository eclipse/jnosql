...
/**
 *This package contains all objects to use a Document Collection. This API gonna focus in domain, in other words, ubiquitous language.
 ...
 * opaque to the database, whereas a document-oriented system relies on internal structure in the document in order to extract
 * metadata that the database engine uses for further optimization. Although the difference is often moot due to tools in the systems,
 ...
 * This makes mapping objects into the database a simple task, normally eliminating anything similar to an object-relational mapping. This makes document stores attractive

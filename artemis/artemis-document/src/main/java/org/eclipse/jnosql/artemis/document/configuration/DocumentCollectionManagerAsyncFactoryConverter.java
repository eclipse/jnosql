 ...
 */
public class DocumentCollectionManagerAsyncFactoryConverter extends AbstractConfiguration<DocumentCollectionManagerAsyncFactory>
        implements Converter<DocumentCollectionManagerAsyncFactory> {

    @Override
    public DocumentCollectionManagerAsyncFactory success(String value) {

...
public class DocumentRepositoryConfigurationTest {
    ...
    public void shouldRepository() {
        DocumentRepositorySupplier<PersonRepository> supplier = services.getRepository();
    ...
    public void shouldRepositoryAsync() {
        DocumentRepositoryAsyncSupplier<PersonRepositoryAsync> supplier = services.getRepositoryAsync();
        assertNotNull(supplier);
